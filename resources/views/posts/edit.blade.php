...
<div class="col-xs-12 col-sm-8 col-md-9  " style="text-align:left;">
        <div style="text-align:center">
            ...
            <div class="form-group">
                    {{Form::label('url', 'URL')}}
                    {{Form::text('url', $post->file_url, ['class' => 'form-control', 'placeholder' => 'Online Link to the Article/Publication (if any)'])}}
            </div>
            <div class="form-group">
                    {{Form::label('body', 'Body')}}
                    {{Form::textarea('body', $post->body, ['class' => 'form-control', 'id' => 'article-ckeditor', 'placeholder' => 'Description / Write Your Article Here'])}}
            </div>
            <div class="form-group">
